...
scoreboard players set if_result_2585 sandstone_cond 0
...
# Calculate sine using Bhaskara I's approx.
scoreboard players set if_result_7402 sandstone_cond 0
...
scoreboard players set if_result_9064 sandstone_cond 0
...
# 
scoreboard players set if_result_5324 sandstone_cond 0
execute if score @s wasd._calc1 matches 1.. run function wasd_test:_wasd/math/if_4
execute if score if_result_5324 sandstone_cond matches 0 if score @s wasd._calc1 matches ..-1 run function wasd_test:_wasd/math/else_if
# # Calculate Local Rotation
# Calculate arc tangent (atan2)
scoreboard players operation @s wasd._calc0 /= @s wasd._calc1
scoreboard players set if_result_1142 sandstone_cond 0
...
scoreboard players set if_result_5342 sandstone_cond 0
