...
# 
scoreboard players reset cond_105 sandstone
execute store success score cond_105 sandstone if score @s wasd._calc1 matches 1.. run tag @s add wasd.forward
execute if score cond_105 sandstone matches 0.. if score @s wasd._calc1 matches ..-1 store success score cond_105 sandstone run tag @s add wasd.backward
...
execute if entity @s[tag=wasd._invert] run function wasd_test:_wasd/math/if
...
execute if entity @s[tag=wasd._invert] run function wasd_test:_wasd/math/if_2
execute if entity @s[tag=wasd._flip] run function wasd_test:_wasd/math/if_3
execute if entity @s[tag=wasd._negate] run function wasd_test:_wasd/math/if_4
