...
scoreboard players set if_result_9147 sandstone_cond 0
scoreboard players set cond_1 sandstone_cond 0
execute unless if score @s wasd.vec_x matches 1.. unless if score @s wasd.vec_z matches 1.. run scoreboard players set cond_1 sandstone_cond 1
execute unless score cond_1 sandstone_cond matches 1 run function wasd:mounted/if