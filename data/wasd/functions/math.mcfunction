...
scoreboard players set if_result_6979 sandstone_cond 0
...
scoreboard players operation @s wasd._calc1 /= @s wasd._calc0
execute as @s[tag=wasd._negate] run function wasd:math/execute_as_2
...
# Calculate sine using Bhaskara I's approx.
scoreboard players set if_result_5731 sandstone_cond 0
...
scoreboard players operation @s wasd._calc0 /= 1000 sandstone_const
scoreboard players operation @s wasd._calc1 /= @s wasd._calc0
execute as @s[tag=wasd._negate] run function wasd:math/execute_as_4
tag @s remove wasd._negate
# 
...
scoreboard players set if_result_1002 sandstone_cond 0
...
# 
scoreboard players set if_result_5751 sandstone_cond 0
execute if score @s wasd._calc1 matches 1.. run function wasd:math/if_4
execute if score if_result_5751 sandstone_cond matches 0 if score @s wasd._calc1 matches ..-1 run function wasd:math/else_if
# # Calculate Local Rotation
# Calculate arc tangent (atan2)
scoreboard players operation @s wasd._calc0 /= @s wasd._calc1
scoreboard players set if_result_475 sandstone_cond 0
...
scoreboard players set if_result_1790 sandstone_cond 0
...
execute as @s[tag=wasd._invert] run function wasd:math/execute_as_7
execute as @s[tag=wasd._flip] run function wasd:math/execute_as_8
execute as @s[tag=wasd._negate] run function wasd:math/execute_as_9
