...
scoreboard players set if_result_4162 sandstone_cond 0
execute if score @s wasd._calc0 matches 180000.. run function wasd:_wasd/math/if
execute as @s[tag=wasd._negate] run function wasd:_wasd/math/execute_as
...
scoreboard players operation @s wasd._calc1 /= @s wasd._calc0
execute as @s[tag=wasd._negate] run function wasd:_wasd/math/execute_as_2
...
# Calculate sine using Bhaskara I's approx.
scoreboard players set if_result_5620 sandstone_cond 0
execute if score @s wasd._calc0 matches 180000.. run function wasd:_wasd/math/if_2
execute as @s[tag=wasd._negate] run function wasd:_wasd/math/execute_as_3
scoreboard players set @s wasd._calc1 180000
scoreboard players operation @s wasd._calc1 -= @s wasd._calc0
scoreboard players operation @s wasd._calc1 /= 1000 sandstone_const
scoreboard players operation @s wasd._calc1 *= @s wasd._calc0
...
scoreboard players operation @s wasd._calc0 /= 1000 sandstone_const
scoreboard players operation @s wasd._calc1 /= @s wasd._calc0
execute as @s[tag=wasd._negate] run function wasd:_wasd/math/execute_as_4
tag @s remove wasd._negate
# 
...
scoreboard players set if_result_4354 sandstone_cond 0
execute if score @s wasd._calc0 matches ..-1 run function wasd:_wasd/math/if_3
...
# 
scoreboard players set if_result_2309 sandstone_cond 0
execute if score @s wasd._calc1 matches 1.. run function wasd:_wasd/math/if_4
execute if score if_result_2309 sandstone_cond matches 0 if score @s wasd._calc1 matches ..-1 run function wasd:_wasd/math/else_if
# # Calculate Local Rotation
# Calculate arc tangent (atan2)
scoreboard players operation @s wasd._calc0 /= @s wasd._calc1
scoreboard players set if_result_2152 sandstone_cond 0
execute if score @s wasd._calc0 matches ..-1 run function wasd:_wasd/math/if_5
execute as @s[tag=wasd._flip] run function wasd:_wasd/math/execute_as_5
scoreboard players set if_result_7544 sandstone_cond 0
execute if score @s wasd._calc0 matches 11.. run function wasd:_wasd/math/if_6
execute as @s[tag=wasd._invert] run function wasd:_wasd/math/execute_as_6
...
execute as @s[tag=wasd._invert] run function wasd:_wasd/math/execute_as_7
execute as @s[tag=wasd._flip] run function wasd:_wasd/math/execute_as_8
execute as @s[tag=wasd._negate] run function wasd:_wasd/math/execute_as_9
