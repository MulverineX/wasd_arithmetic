...
scoreboard players set if_result_7107 sandstone_cond 0
scoreboard players set cond_0 sandstone_cond 0
execute unless if score @s wasd.vec_x matches 1.. unless if score @s wasd.vec_z matches 1.. run scoreboard players set cond_0 sandstone_cond 1
