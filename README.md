...
ie. `execute as @a if predicate mountedwasd:predicates/is_mounted run function mounted_wasd:_wasd/get_input` (Mounted predicate checks if the player is riding anything; nonessential, not supported in 1.14 nor 1.13)
