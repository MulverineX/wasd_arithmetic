...
scoreboard players set if_result_5990 sandstone_cond 0
execute if score @s mtwasd._calc0 matches 180000.. run function mtwasd_test:_wasd/calculate/if
execute as @s[tag=mountedwasd._negate] run function mtwasd_test:_wasd/calculate/execute_as
...
scoreboard players operation @s mtwasd._calc1 /= @s mtwasd._calc0
execute as @s[tag=mountedwasd._negate] run function mtwasd_test:_wasd/calculate/execute_as_2
...
# Calculate sine using Bhaskara I's approx.
scoreboard players set if_result_1655 sandstone_cond 0
execute if score @s mtwasd._calc0 matches 180000.. run function mtwasd_test:_wasd/calculate/if_2
execute as @s[tag=mountedwasd._negate] run function mtwasd_test:_wasd/calculate/execute_as_3
scoreboard players set @s mtwasd._calc1 180000
scoreboard players operation @s mtwasd._calc1 -= @s mtwasd._calc0
scoreboard players operation @s mtwasd._calc1 /= 1000 sandstone_const
scoreboard players operation @s mtwasd._calc1 *= @s mtwasd._calc0
...
scoreboard players operation @s mtwasd._calc0 /= 1000 sandstone_const
scoreboard players operation @s mtwasd._calc1 /= @s mtwasd._calc0
execute as @s[tag=mountedwasd._negate] run function mtwasd_test:_wasd/calculate/execute_as_4
tag @s remove mountedwasd._negate
# 
...
scoreboard players set if_result_1023 sandstone_cond 0
execute if score @s mtwasd._calc0 matches ..-1 run function mtwasd_test:_wasd/calculate/if_3
...
# 
scoreboard players set if_result_1946 sandstone_cond 0
execute if score @s mtwasd._calc1 matches 1.. run function mtwasd_test:_wasd/calculate/if_4
execute if score if_result_1946 sandstone_cond matches 0 if score @s mtwasd._calc1 matches ..-1 run function mtwasd_test:_wasd/calculate/else_if
# # Calculate Local Rotation
# Calculate arc tangent (atan2)
scoreboard players operation @s mtwasd._calc0 /= @s mtwasd._calc1
scoreboard players set if_result_7159 sandstone_cond 0
execute if score @s mtwasd._calc0 matches ..-1 run function mtwasd_test:_wasd/calculate/if_5
execute as @s[tag=mountedwasd._flip] run function mtwasd_test:_wasd/calculate/execute_as_5
scoreboard players set if_result_4233 sandstone_cond 0
execute if score @s mtwasd._calc0 matches 11.. run function mtwasd_test:_wasd/calculate/if_6
execute as @s[tag=mountedwasd._invert] run function mtwasd_test:_wasd/calculate/execute_as_6
...
execute as @s[tag=mountedwasd._invert] run function mtwasd_test:_wasd/calculate/execute_as_7
execute as @s[tag=mountedwasd._flip] run function mtwasd_test:_wasd/calculate/execute_as_8
execute as @s[tag=mountedwasd._negate] run function mtwasd_test:_wasd/calculate/execute_as_9
