...
scoreboard players set if_result_773 sandstone_cond 0
...
scoreboard players set if_result_3140 sandstone_cond 0
...
# Calculate sine using Bhaskara I's approx.
scoreboard players operation @s mtwasd._calc0 %= 360000 mtwasd._calc0
scoreboard players set if_result_7334 sandstone_cond 0
...
scoreboard players set if_result_7642 sandstone_cond 0
...
scoreboard players set if_result_3284 sandstone_cond 0
execute if score @s mtwasd._calc1 matches 1.. run function mountedwasd:_wasd/calculate/if_5
execute if score if_result_3284 sandstone_cond matches 0 if score @s mtwasd._calc1 matches ..-1 run function mountedwasd:_wasd/calculate/else_if
# # Calculate Local Rotation
# Calculate arc tangent (atan2)
scoreboard players operation @s mtwasd._calc0 /= @s mtwasd._calc1
scoreboard players set if_result_9029 sandstone_cond 0
...
scoreboard players set if_result_1682 sandstone_cond 0
...
# atan2(det/dot)
tellraw @s {"score": {"name": "@s", "objective": "mtwasd._calc0"}}
